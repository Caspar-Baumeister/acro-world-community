...
import 'package:acroworld/components/images/event_image_picker_component.dart';
...
import 'package:acroworld/screens/creator_mode_screens/location_picker_page/map_location_picker_page.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              InputFieldComponent(
                ...
                validator: (p0) => p0!.isEmpty ? 'Name cannot be empty' : null,
              ...
              CustomLocationInputComponent(
                ...
                onLocationSelected:
                  ...
                  provider.setLocationDescription(locationDescription ?? '');
                },
              ),
              const SizedBox(height: AppPaddings.medium),
