// import 'package:acroworld/presentation/components/bottom_navbar/primary_bottom_navbar.dart'; // Removed - using shell navigation
...
class _TeacherPageState extends State<TeacherPage> {
  ...
  Widget build(BuildContext context) {
    return BasePage(
      ...
      // bottomNavigationBar: const PrimaryBottomNavbar(selectedIndex: 2), // Removed - handled by shell
      child: Column(
