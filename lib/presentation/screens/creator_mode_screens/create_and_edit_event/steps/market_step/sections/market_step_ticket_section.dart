      ...
      children: [
        StandardButton(
            ...
            onPressed: () {
              buildMortal(context, AddOrEditBookingOptionModal(
                onFinished: (BookingOptionModel bookingOption) {
        ...
        Expanded(
          child: ListView.builder(
              shrinkWrap: true,
              reverse: false,
              itemCount: eventCreationAndEditingProvider.bookingOptions.length,
              itemBuilder: (context, index) {
                BookingOptionModel bookingOption =
                          ...
                          Column(
                            ...
                            children: [
                              bookingOption.subtitle != null &&
                                  ...
                                  : Container(),
                              Text(
                                '${bookingOption.price} ${bookingOption.currency}',
                                style: Theme.of(context)
                                    .textTheme
                                    .bodyMedium!
