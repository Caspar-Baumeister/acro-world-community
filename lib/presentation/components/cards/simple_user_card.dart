...
/// A simple user card component without animations for debugging
...
/// A simple follow button without animations
class _SimpleFollowButton extends StatelessWidget {
  const _SimpleFollowButton({
    required this.isFollowed,
