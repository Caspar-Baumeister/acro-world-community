...
class ClassModel {
  ...
  ClassModel.fromJson(Map<String, dynamic> json) {
    ...
    print('🔍 CLASSMODEL DEBUG - recurring_patterns type: ${json["recurring_patterns"].runtimeType}');
    print('🔍 CLASSMODEL DEBUG - recurring_patterns is null: ${json["recurring_patterns"] == null}');
    
    // Check for alternative field names
    print('🔍 CLASSMODEL DEBUG - Checking for alternative field names:');
    print('🔍 CLASSMODEL DEBUG - recurringPatterns: ${json["recurringPatterns"]}');
    print('🔍 CLASSMODEL DEBUG - recurringPatterns type: ${json["recurringPatterns"].runtimeType}');
    print('🔍 CLASSMODEL DEBUG - patterns: ${json["patterns"]}');
    print('🔍 CLASSMODEL DEBUG - patterns type: ${json["patterns"].runtimeType}');
    
    createdBy =
        json['created_by'] != null ? User.fromJson(json['created_by']) : null;

    if (json["recurring_patterns"] != null) {
      print('🔍 CLASSMODEL DEBUG - Processing recurring_patterns, count: ${json["recurring_patterns"].length}');
      ...
      json["recurring_patterns"].forEach((v) {
        ...
        print('🔍 CLASSMODEL DEBUG - Added pattern, total count: ${recurringPatterns!.length}');
      });
      print('🔍 CLASSMODEL DEBUG - Final recurringPatterns count: ${recurringPatterns!.length}');
    } else {
