...
void main() {
  group('Compilation Tests', () {
    ...
    test('Provider types should be correct', () {
      ...
      expect(userRoleProvider,
          isA<StateNotifierProvider<UserRoleNotifier, bool>>());
      expect(discoveryProvider,
          isA<StateNotifierProvider<DiscoveryNotifier, DiscoveryState>>());
      expect(
          placeProvider, isA<StateNotifierProvider<PlaceNotifier, Place?>>());
      expect(eventFilterProvider,
          isA<StateNotifierProvider<EventFilterNotifier, EventFilterState>>());
    });
    ...
    test('Widget constructors should have correct parameters', () {
      ...
      expect(
          () => BackDropActionRow(
                ...
                shareEvents: () {},
                classObject:
                    ClassModel(questions: []), // Minimal required parameters
